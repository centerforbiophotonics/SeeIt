    ...
    function box(g) {
        g.each(function(d, i) {
            ...
            q1q2Box.enter().append('rect')
                ...
                .attr('y', 0)
                .attr('x', function(d) {
                    return xScale(d.length ? value(d[0]) : quartileVals[0]);
                })
                .attr('width', function(d) {
                    return xScale(d.length ? value(d[d.length - 1]) : quartileVals[1]) - xScale(d.length ? value(d[0]) : quartileVals[0]);
                })
                .attr('height', height);
            ...
            q2q3Box.enter().append('rect')
                ...
                .attr('y', 0)
                .attr('x', function(d) {
                    return xScale(d.length ? value(d[0]) : quartileVals[1]);
                })
                .attr('width', function(d) {
                    return xScale(d.length ? value(d[d.length - 1]) : quartileVals[2]) - xScale(d.length ? value(d[0]) : quartileVals[1]);
                })
                .attr('height', height);
